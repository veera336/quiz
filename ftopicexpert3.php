...
<body>
    ...
    <div class="level-container">
        ...
        echo '<a href="ftopicexpert.php" class="level-box">Level 1</a>';
       

        if ($userProgress['level_1_points'] > 1) {
            echo '<a href="ftopicexpert1.php" class="level2-box">Level 2</a>';
        } else {
            echo "<script>alert('Complete Level 1 first.');</script>";
        }

        if ($userProgress['level_2_points'] > 1) {
            echo '<a href="ftopicexpert2.php" class="level3-box">Level 3</a>';
        } else {
            echo "<script>alert('Complete Level 2 first.');</script>";
        }

        if ($userProgress['level_3_points'] > 1) {
            echo '<a href="ftopicexpert3.php" class="level4-box">Level 4</a>';
        } else {
