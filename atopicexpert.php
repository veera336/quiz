...
if (mysqli_num_rows($result) == 1) {
   ...
   // Populate the user progress array with relevant data from the user_info table
$userProgress['level_1_points'] = isset($row['a_exp_level1']) ? $row['a_exp_level1'] : 0;
$userProgress['level_2_points'] = isset($row['a_exp_level2']) ? $row['a_exp_level2'] : 0;
$userProgress['level_3_points'] = isset($row['a_exp_level3']) ? $row['a_exp_level3'] : 0;
$userProgress['level_4_points'] = isset($row['a_exp_level4']) ? $row['a_exp_level4'] : 0;
...
body {
    ...
    box-sizing: border-box;
    background-image:url(./strlevex22.jpg)
...
<!-- <a href="learnexp.php" class="GO-box">GO =></a> -->
</body>
</html>
