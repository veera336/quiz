...
if (mysqli_num_rows($result) == 1) {
    ...
    $userProgress['level_1_points'] = $row['a_int_level1'];
    $userProgress['level_2_points'] = $row['a_int_level2'];
    $userProgress['level_3_points'] = $row['a_int_level3'];
    $userProgress['level_4_points'] = $row['a_int_level4'];
} else {
...
<body>
    <header>
        <h2 class="logo">Problem Solving Quizz</h2>
        <nav class="navigation">
        <a href="competency.php">Home</a>
            <a href="#">About</a>
            <a href="#">Contact</a>
            <a href="login.html" class="btnlogout" style="background-color:#808dff;">Logout</a>
        </nav>
    </header>
   
    <div class="level-container">
        <div class="parrot">
            <img src="pngkey.com-problem-png-9574728.png" alt="ppngkey.com-problem-png-9574728.png" />
        </div>

        <?php
        // Check conditions for each level and generate links or alert messages accordingly

        echo '<a href="atopicinter.php" class="level-box">Level 1</a>';
       

        if ($userProgress['level_1_points'] > 5) {
            echo '<a href="atopicinter1.php" class="level2-box">Level 2</a>';
        } else {
            echo "<script>alert('Complete Level 1 first.');</script>";
        }

        if ($userProgress['level_2_points'] > 5) {
            echo '<a href="atopicinter2.php" class="level3-box">Level 3</a>';
        } else {
            echo "<script>alert('Complete Level 2 first.');</script>";
        }
        if ($userProgress['level_3_points'] > 5) {
            echo '<a href="topicinter3.php" class="level4-box">Level 4</a>';
        } else {
...
<!-- <a href="learnint2.php" class="GO-box">GO =></a> -->
</body>
</html>
