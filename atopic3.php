...
<body>
    ...
    <div class="level-container">
        <div class="parrot">
            <img src="pngkey.com-problem-png-9574728.png" alt="pngkey.com-problem-png-9574728.png" />
        </div>

        <?php
        // Check conditions for each level and generate links or alert messages accordingly

        echo '<a href="atopic.php" class="level-box">Level 1</a>';
       

        if ($userProgress['level_1_points'] > 1) {
            echo '<a href="atopic1.php" class="level2-box">Level 2</a>';
        } else {
            echo "<script>alert('Complete Level 1 first.');</script>";
        }

        if ($userProgress['level_2_points'] > 1) {
            echo '<a href="atopic2.php" class="level3-box">Level 3</a>';
        } else {
            echo "<script>alert('Complete Level 2 first.');</script>";
        }

        if ($userProgress['level_3_points'] > 1) {
            echo '<a href="atopic3.php" class="level4-box">Level 4</a>';
        } else {
...
<!-- <a href="learnexp3.php" class="GO-box">GO =></a> -->
</body>
</html>
