...
if (mysqli_num_rows($result) == 1) {
    ...
    $userProgress['level_1_points'] = $row['a_points'];
    $userProgress['level_2_points'] = $row['a_quiz_score'];
    $userProgress['level_3_points'] = $row['a_level3'];
    $userProgress['level_4_points'] = $row['a_level4'];
} else {
...
<body>
    ...
    <div class="level-container">
        ...
        echo '<a href="alearn.php" class="level-box">Level 1</a>';
       

        if ($userProgress['level_1_points'] > 1) {
            echo '<a href="alearn1.php" class="level2-box">Level 2</a>';
        } else {
            // echo "<script>alert('Complete Level 1 first.');</script>";
        }

        if ($userProgress['level_2_points'] > 1) {
            echo '<a href="alearn2.php" class="level2-box">Level 3</a>';
        } else {
            // echo "<script>alert('Complete Level 1 first.');</script>";
        }
        if ($userProgress['level_3_points'] > 1) {
            echo '<a href="alearn3.php" class="level4-box">Level 4</a>';
        } else {
