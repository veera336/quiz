...
<body>
    <header>
        ...
        <a href="competency.php">Home</a>
            <a href="#">About</a>
            <a href="#">Contact</a>
            <a href="login.html" class="btnlogout" style="background-color:#808dff;">LOG OUT</a>
        </nav>
    </header>
   
    <div class="level-container">
        <div class="parrot">
            <img src="welcome.png" alt="ppngkey.com-problem-png-9574728.png" />
        </div>
        ...
        if ($userProgress['level_3_points'] > 5) {
            echo '<a href="atopicinter3.php" class="level4-box">Level 4</a>';
        } else {
...
<!-- <a href="alearnint1.php" class="GO-box">GO =></a> -->
</body>
</html>
