...
if (mysqli_num_rows($result) == 1) {
    ...
    $userProgress['level_1_points'] = $row['a_exp_level1'];
    $userProgress['level_2_points'] = $row['a_exp_level2'];
    $userProgress['level_3_points'] = $row['a_exp_level3'];
    $userProgress['level_4_points'] = $row['a_exp_level4'];
} else {
...
<body>
    ...
    <div class="level-container">
        ...
        echo '<a href="atopicexpert.php" class="level-box">Level 1</a>';
       

        if ($userProgress['level_1_points'] > 5) {
            echo '<a href="atopicexpert1.php" class="level2-box">Level 2</a>';
        } else {
...
<!-- <a href="learnexp1.php" class="GO-box">GO =></a> -->
</body>
</html>
