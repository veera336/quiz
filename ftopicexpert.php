...
if (mysqli_num_rows($result) == 1) {
   ...
   // Populate the user progress array with relevant data from the user_info table
$userProgress['level_1_points'] = isset($row['exp_level1']) ? $row['exp_level1'] : 0;
$userProgress['level_2_points'] = isset($row['exp_level2']) ? $row['exp_level2'] : 0;
$userProgress['level_3_points'] = isset($row['exp_level3']) ? $row['exp_level3'] : 0;
$userProgress['level_4_points'] = isset($row['exp_level4']) ? $row['exp_level4'] : 0;
...
<body>
    ...
    <div class="level-container">
        ...
        echo '<a href="flearnexp.php" class="level-box">Level 1</a>';
       

        if ($userProgress['level_1_points'] > 1) {
            echo '<a href="flearnexp1.php" class="level2-box">Level 2</a>';
        } else {
            echo "<script>alert('Complete Level 1 first.');</script>";
        }

        if ($userProgress['level_2_points'] > 1) {
            echo '<a href="flearnexp2.php" class="level3-box">Level 3</a>';
        } else {
            // echo "<script>alert('Complete Level 2 first.');</script>";
        }
        if ($userProgress['level_3_points'] > 1) {
            echo '<a href="flearnexp3.php" class="level4-box">Level 4</a>';
        } else {
